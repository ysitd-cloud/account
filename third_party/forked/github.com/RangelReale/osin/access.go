...
const (
	AuthorizationCode AccessRequestType = "authorization_code"
	RefreshToken      AccessRequestType = "refresh_token"
	Password          AccessRequestType = "Password"
	ClientCredentials AccessRequestType = "client_credentials"
